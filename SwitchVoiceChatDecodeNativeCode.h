...
namespace SwitchVoiceChatDecodeNativeCode {
	...
	extern "C" bool wntgd_DecompressVoiceData(intptr_t * handle, unsigned char* inputBuffer, int count, void* audioOut, size_t* outSampleCount, unsigned int* sampleRateOut);
